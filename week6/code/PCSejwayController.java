 ...
 * 
 */
public class PCSejwayController extends JFrame implements ActionListener
{
   private TextField nameField = new TextField(12);
   private TextField addressField = new TextField(20);

   private String name = "Lego Logen"; 
   private String address = "001653131118";
   ...
   public void actionPerformed(ActionEvent e)
   {
      ...
      if(e.getSource()== goButton)
      {
		...
		int offset = new Integer(offsetString).intValue();
   ...
   {
      PCSejwayController frame = new PCSejwayController();
